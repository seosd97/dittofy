...
## Goal
Create two showcase pages (Home and About) with core UI components (Button, Card, Section) that demonstrate the design system in action. These pages are NOT replicas of the source — they showcase the extracted design tokens, typography, and layout patterns with generic content.
...
function buildFullDesignReference(
	...
	// Layout
	if (layout) {
		sections.push(`\n### Layout\n**Approach**: ${layout.approach.value}`)
